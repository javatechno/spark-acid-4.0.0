...
import com.qubole.shaded.commons.codec.binary.Base64
import com.qubole.shaded.hadoop.conf.Configuration
import com.qubole.shaded.hadoop.fs.{Path, PathFilter}
import com.qubole.shaded.hadoop.io.Writable
import com.qubole.shaded.hadoop.mapred.{FileInputFormat, InputFormat, JobConf}
